...
url = '/Volumes/marioni-lab/Ola/Lab/EpiScores/Improving_assign/runs/w1_w3_w4_normalised_sep/age_sex_set/cox_assign_raw_fs_settings_set_added.json'
...
x = subset(df, select = -c(ID, tte, event))
x = as.matrix(x)
